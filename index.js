...
for(let j=1;j<=20;j++)
{
  ...
  document.querySelector("#b"+j).addEventListener("click",function(){
    ...
    if(cc==count)
    {
      ...
      {
        timerObject.stop();
        if(localStorage.getItem(levelValue+"bett1")==null)
          {
          localStorage.setItem(levelValue+"bett1",document.querySelector(".timerSpan").textContent);

        }
        else if(localStorage.getItem(levelValue+"bett2")==null)
        {
          localStorage.setItem(levelValue+"bett2",document.querySelector(".timerSpan").textContent);
        }
        else if(localStorage.getItem(levelValue+"bett3")==null)
        {
          localStorage.setItem(levelValue+"bett3",document.querySelector(".timerSpan").textContent);
        }
        else if(localStorage.getItem(levelValue+"bett4")==null)
        {
          localStorage.setItem(levelValue+"bett4",document.querySelector(".timerSpan").textContent);
        }
        else if(localStorage.getItem(levelValue+"bett5")==null)
        {
          localStorage.setItem(levelValue+"bett5",document.querySelector(".timerSpan").textContent);
        }else if(localStorage.getItem(levelValue+"bett6")==null||localStorage.getItem(levelValue+"bett6")=="")
        {
          localStorage.setItem(levelValue+"bett6",document.querySelector(".timerSpan").textContent);
        }
        if(localStorage.getItem(levelValue+"bett6")!=null)
        {
          for(x1=1;x1<=6;x1++)
          {
            for(x2=x1+1;x2<=6;x2++)
            {
              if(Number(localStorage.getItem(levelValue+"bett"+x2))<Number(localStorage.getItem(levelValue+"bett"+x1)))
              {
                temp=localStorage.getItem(levelValue+"bett"+x1);
                localStorage.setItem(levelValue+"bett"+x1,localStorage.getItem(levelValue+"bett"+x2));
                localStorage.setItem(levelValue+"bett"+x2,temp);
              }
          ...
          for(y1=1;y1<=5;y1++)
          {
            document.querySelector("#el"+y1).textContent=localStorage.getItem("bett"+y1);

          }
          localStorage.setItem(levelValue+"bett6","");
        ...
        else if(localStorage.getItem(levelValue+"bett5")!=null)
        {
          ...
          for(y1=1;y1<=5;y1++)
          {
            document.querySelector("#el"+y1).textContent=localStorage.getItem(levelValue+"bet"+y1);
          }
        ...
        else if(localStorage.getItem(levelValue+"bett4")!=null)
        {
          ...
          for(y1=1;y1<=3;y1++)
          {
            document.querySelector("#el"+y1).textContent=localStorage.getItem(levelValue+"bett"+y1);
          }
        ...
        else if(localStorage.getItem(levelValue+"bett1")!=null)
        {
          for(x1=1;x1<=1;x1++)
          {
            for(x2=x1+1;x2<=1;x2++)
        ...
        document.querySelector("#ng").style.height="130px";
        document.querySelector("#ng").style.width="150px";
